...
\section{Experience}
\datedexperience{Google Quantum AI}{2021--Present}
\explanation{Systems Engineer}
\explanationdetail{
	\coloredbullet\ Worked on QKernel, the operating system / control software
	for the quantum computer.\par
	\coloredbullet\ Woked on QCC, the quantum circuit compiler.\par
}
