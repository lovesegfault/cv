...
\explanationdetail{
	\begin{itemize}
		...
		\item Strong communication skills, taking pride to speak to others with candor
		      and compassion.
	\end{itemize}
}
...
\explanationdetail{
	\coloredbullet\ Started as summer intern and was promoted to full-time
...
% These projects should be qualified in the title as "Open-Source" or
% "Personal" as opposed to "industry" in the introductory "At a Glance"
% section.
