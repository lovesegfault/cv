...
\explanationdetail{
	\begin{itemize}
		...
		\item Extensive experience porting large codebases to Rust.
...
\explanationdetail{
	\coloredbullet\ Working on CargoBrazil, the integration between Cargo and
	Amazon's internal build system.\par
	\coloredbullet\ Held the weekly Nix office hours, helping many dozens of
...
\explanation{Systems Software Engineer}
\explanationdetail{
