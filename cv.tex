...
\section{Experience}
\datedexperience{Anthropic}{2025--Present}
\explanation{Member of Technical Staff}
\explanationdetail{
  \coloredbullet\ Work on the Developer Platform team, which owns the build
  and developer infrastructure powering Anthropic's engineering and research
  organizations.\par
  \coloredbullet\ Focus on Nix remote build infrastructure, delivering fast,
  reproducible builds at company scale.\par
  \vspace*{2.5mm}
}
\datedexperience{AWS}{2022--2025}
\explanation{SDE III  2023--2025}
\explanationdetail{
...
\newpage%
\noindent\datedexperience{Standard Cognition}{2018--2021}
